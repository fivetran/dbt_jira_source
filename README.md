# [DEPRECATED] Jira Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_jira`](https://github.com/fivetran/dbt_jira) instead, which now contains all models previously found here._
